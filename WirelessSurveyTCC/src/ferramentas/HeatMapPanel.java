...
public class HeatMapPanel extends JPanel {
    ...
    public final static int HEIGHT = 1030;
    public final static int WIDTH = 630;
    public final static Color minhaCor = new Color(0, 0, 0, 0);
    ...
    public static void main(String[] args) {
        ...
        int SIZE = HEIGHT*WIDTH/1000;
        
        Color cor;
        cor = HeatMapPanel.minhaCor;
        
        //HeatMapPanel heatMap = new HeatMapPanel(HeatMapPanel.generateSinCosData(SIZE), true, cores );
        //HeatMapPanel heatMap = new HeatMapPanel(HeatMapPanel.generateRampTestData(SIZE), true, cores );
        ...
        JPanel loucura = new JPanel(null);
        loucura.setBackground(Color.BLACK);
        JPanel main = new JPanel();
        
        heatMap.setSize(1030, 630);
        //main.add(loucura, BorderLayout.CENTER);
        main.add(heatMap, BorderLayout.WEST);
        main.setSize(1280, 720);
        main.setBackground(Color.black);
        main.setVisible(true);

        janela.getContentPane().add( heatMap , null);
        
        janela.setVisible(true);
        janela.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    }

    public static Color[] createGradient(int steps){
        Color gradientColors[] = new Color[steps];
        ...
        for (int i = 0; i < steps; i++) {
            ...
            Color stepColor = new Color(red, green, blue , 225); //alpha é a transparência da cor
            gradientColors[i] = stepColor;
        }
  ...
  public HeatMapPanel(double[][] data, boolean useGraphicsYAxis, Color[] colors) {
    ...
    this.bg = minhaCor/*Color.white*/;
    this.fg = minhaCor/*Color.black*/;
   ...
   */
  public static double[][] generateRampTestData(int steps) {
    double[][] data = new double[steps][steps];
  ...
  public static double[][] generateRandomTestData(int steps) {
    double[][] data = new double[steps][steps];
    for (int x = 0; x < steps; x++) {
      for (int y = 0; y < steps; y++) {
        data[x][y] = (1 + Math.random()*100);
      }
    }
  ...
  public void paintComponent(Graphics g) {
    ...
    g.drawOval((WIDTH/2)+55, (HEIGHT/2)+55, 50, 50);

    g.setColor(Color.black);
    g.drawOval((WIDTH/3)+55, (HEIGHT/3)+55, 50, 50);

    g.setColor(Color.black);
    g.drawOval(155, 155, 50, 50);

    g.setColor(Color.red);
    g.drawRect(WIDTH/2, HEIGHT/2, 50, 50);

    g.setColor(Color.red);
    g.drawRect(WIDTH/3, HEIGHT/3, 50, 50);
